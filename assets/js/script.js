 ...
 $('#my-modal').on('show.bs.modal', function (event) {
  ...
  modal.find('.modal-body').html(
    ...
    "<tr><td>41</td><td>Plastia comunic&#259;rii oro-sinusale</td><td>200</td><td>x</td></tr></tbody></table></div>").addClass('silver').removeClass('platinum gold')
  ...
  modal.find('.modal-body').html(
    ...
    "<tr><td>41</td><td>Plastia comunic&#259;rii oro-sinusale</td><td>200</td><td>x</td></tr></tbody></table></div>").addClass('gold').removeClass('silver platinum')
  ...
  modal.find('.modal-body').html(
    ...
    ).addClass('platinum').removeClass('silver gold')
